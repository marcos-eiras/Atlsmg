 <nav id="smoothmenu1" class="ddsmoothmenu mainMenu"> 
    ...
    <ul id="nav">
        ...
        <li <?php if(isset($active[8])) echo $active[8] ?>><a href="https://www.facebook.com/pages/Atlsmg/1560131997587069" title="facebook" target="_blank"><img src="img/facebook.jpg" height="30px" width="25px"/></a></li>
    </ul>
</nav>
