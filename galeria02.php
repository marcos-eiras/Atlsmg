...
<section class="content-wrapper" style="background-color: #CCCECF;">
		...
		<ul>
			<li>
				<a href="galeria/02/thumbnail/1.jpg">
					<img src="galeria/02/medium/1p.jpg" alt="" />
				</a>
			</li>
			<li>
				<a href="galeria/02/thumbnail/2.jpg">
					<img src="galeria/02/medium/2p.jpg" alt="" />
				</a>
			</li>
			<li>
				<a href="galeria/02/thumbnail/3.jpg">
					<img src="galeria/02/medium/3p.jpg" alt="" />
				</a>
			</li>
			<li>
				<a href="galeria/02/thumbnail/4.jpg">
					<img src="galeria/02/medium/4p.jpg" alt="" />
				</a>
			</li>
			<li>
				<a href="galeria/02/thumbnail/5.jpg">
					<img src="galeria/02/medium/5p.jpg" alt="" />
				</a>
			</li>
<!-- <center><hr style="width: 98%; height: 1px; background-color: rgb(89, 141, 202);"></hr></center>-->
             <li>
				<a href="galeria/02/thumbnail/6.jpg">
					<img src="galeria/02/medium/6p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/7.jpg">
					<img src="galeria/02/medium/7p.jpg" alt="" />
				</a>
			</li>
            <li>
				<a href="galeria/02/thumbnail/8.jpg">
					<img src="galeria/02/medium/8p.jpg" alt="" />
				</a>
			</li>
            <li>
				<a href="galeria/02/thumbnail/9.jpg">
					<img src="galeria/02/medium/9p.jpg" alt="" />
				</a>
			</li>
            <li>
				<a href="galeria/02/thumbnail/10.jpg">
					<img src="galeria/02/medium/10p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/11.jpg">
					<img src="galeria/02/medium/11p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/12.jpg">
					<img src="galeria/02/medium/12p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/13.jpg">
					<img src="galeria/02/medium/13p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/14.jpg">
					<img src="galeria/02/medium/14p.jpg" alt="" />
				</a>
			</li>
             <li>
				<a href="galeria/02/thumbnail/15.jpg">
					<img src="galeria/02/medium/15p.jpg" alt="" />
				</a>
			</li>
            
             <li>
				<a href="galeria/02/thumbnail/16.jpg">
					<img src="galeria/02/medium/16p.jpg" alt="" />
				</a>
			</li>
              <li>
				<a href="galeria/02/thumbnail/17.jpg">
					<img src="galeria/02/medium/17p.jpg" alt="" />
				</a>
