...
if(isset($_GET['acao']) && $_GET['acao']==='adicionar'){
    ...
    $recarrega_securimage = 'document.getElementById(\'captcha_image\').src = \'/Framework/www/Classes/Securimage/securimage_show.php?\' + Math.random();';
   ...
   if(isset($_POST['senha'])){$senha = \Framework\App\Sistema_Funcoes::Form_Senha_Blindar($_POST['senha']);
    ...
    //Verifica Grupos
    if ($grupo!='3' && $grupo!='6' && $grupo!='7' && $grupo!='8') {
        $mensagens = array(
            "tipo"              => 'erro',
            "mgs_principal"     => 'Categoria Incorreta',
            "mgs_secundaria"    => 'Por favor Preencha a Categoria Corretamente'
        );
        $Visual->Json_IncluiTipo('Mensagens',$mensagens);
        $Visual->Javascript_Executar(
                '$("#grupo").css(\'border\', \'2px solid #FFAEB0\').focus();'
        );
        ++$erros;
    }
    //Verifica Grupos
    ...
    (grupo,fisica,crm,nome,rg,orgao,razao_social,nome_contato,nomefantasia,cnpj,cnpj_insc,perfil_nascimento,email,telefone,celular,login,senha,
    
    site,cep,pais,estado,cidade,bairro,endereco,numero,telefone2, log_date_add)
    VALUES (\''.$grupo.'\',\''.$fisica.'\',\''.$crm.'\',\''.$nome.'\',\''.$rg.'\',\''.$orgao.'\',\''.$razao_social.'\',\''.$nome_contato.'\',\''.$nomefantasia.'\',\''.$cnpj.'\',\''.$cnpj_insc.'\',\''.$perfil_nascimento.'\',\''.$email.'\',\''.$telefone.'\',\''.$celular.'\',\''.$login.'\',\''.$senha.'\','
                . ''
        ...
        /*    $sucesso2 = $db->query('INSERT INTO Transporte_Caminhoneiro 
        (usuario,categoria,capacidade,telefone,carteira,ano,placa,renavan,ipva,obs1,obs2,obs3, log_date_add)
        VALUES (\''.$identificador_id.'\',\''.$categoria.'\',\''.$capacidade.'\',\''.$telefone.'\',\''.$carteira.'\',\''.$ano.'\',\''.$placa.'\',\''.$renavan.'\',\''.$ipva.'\','
                    . ''
                    . '\''.$obs1.'\',\''.$obs2.'\',\''.$obs3.'\',\''.APP_HORA.'\')');
...
<!--<![endif]-->
<head>
    <link href="<?php echo $endereco_admin; ?>/web/min/?f=sistema/jquery-ui/jquery-ui.min.css,sistema/bootstrap/css/bootstrap.min.css,sistema/bootstrap/css/bootstrap-responsive.min.css,sistema/bootstrap/css/bootstrap-fileupload.css,sistema/nprogress/nprogress.css,sistema/toastr/toastr.min.css,css/plugins/jquery.tiptip.css,css/plugins/jquery.blockui.css,css/jcalendar.css,css/plugins/jquery.fullcalendar.css,css/plugins/jquery.fullcalendar.print.css,assets/font-awesome/css/font-awesome.css,assets/metr-folio/css/metro-gallery.css,assets/uniform/css/uniform.default.css,assets/chosen/chosen.min.css,assets/jquery-tags-input/jquery.tagsinput.css,assets/bootstrap-datepicker/css/datepicker.css,assets/bootstrap-timepicker/compiled/timepicker.css,assets/bootstrap-colorpicker/css/colorpicker.css,assets/bootstrap-daterangepicker/daterangepicker.css,assets/bootstrap-wysihtml5/bootstrap-wysihtml5.css,sistema/bootstrap-duallistbox/bootstrap-duallistbox.css,css/sistema.css" rel="stylesheet" />
                    ...
                    <div class="col12" id="blocounico">
                        <div class="widget png">
                            <div class="widget-body">
                                <form id="form_Sistema_Admin_Usuarios" class="formajax" action="cadastrar.php?acao=adicionar" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                                <input tabindex="4" type="text" value="" MAXLENGTH="100" id="nome" name="nome" class="col12  obrigatorio masc_letras"  escondendo="ativado" /> 
                                                                            </div>
                                        </div>
                                        
                                        <div class="control-group">
                                            <label class="control-label" for="cpf">CRM:</label>
                                            <div                        class="controls">
                                                                <input tabindex="5" type="text" value="" MAXLENGTH="200" id="cpf" name="cpf" class="col12  masc_cpf"  escondendo="ativado" /> 
                                                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                                <input tabindex="6" type="text" value="" MAXLENGTH="200" id="rg" name="rg" class="col12  masc_rg"  escondendo="ativado" /> 
                                                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" validar="Control_Layoult_Valida_Cep" onblur="Sierra.Control_Layoult_Pesquisa_Cep('#cep')" class="col12  masc_cep" name="cep" id="cep" maxlength="200" value="" tabindex="11"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="estado">Estado*</label>
                                                <div class="controls">
                                                <!--Comeca Select-->
                                                <select data-placeholder="Escolha um Estado" class="col12 form-select-padrao obrigatorio" onchange="Sierra.Modelo_Ajax_Chamar('<?php echo $endereco_admin; ?>/_Sistema/Recurso/Select_Recarrega_Extrangeira/U/estado/'+this.value,'','get',true)" id="estado" name="estado" tabindex="-1" style="display: none;">    <option selected="" value="1">AC</option>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                <!--Comeca Select--><SELECT tabindex="19" name="cidade" id="cidade" onchange="Sierra.Modelo_Ajax_Chamar('<?php echo $endereco_admin; ?>/_Sistema/Recurso/Select_Recarrega_Extrangeira/U/cidade/'+this.value,'','get',true)" class="col12 form-select-padrao obrigatorio" data-placeholder="Escolha uma Cidade">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                <!--Comeca Select--><SELECT tabindex="20" name="bairro" id="bairro" class="col12 form-select-padrao obrigatorio" data-placeholder="Escolha um Bairro">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="21" type="text" value="" MAXLENGTH="200" id="endereco" name="endereco" class="col12 "  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="22" type="text" value="" MAXLENGTH="15" id="numero" name="numero" class="col12 " onkeydown="Sierra.Visual_Formulario_Mascara(this,'Numero');"  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="23" type="text" value="" MAXLENGTH="15" id="complemento" name="complemento" class="col12 "  /> 
                                                                                </div>
                                            </div>
                                        ...
                                        <div class="col6">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input type="text" class="col12  obrigatorio masc_fone" name="telefone" id="telefone" maxlength="30" value="" tabindex="4"> 
                                                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="celular">Celular:</label>
                                                <div class="controls">
                                                                    <input tabindex="16" type="text" value="" MAXLENGTH="30" id="celular" name="celular" class="col12  masc_cel"  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="14" type="text" value="" MAXLENGTH="200" id="email" name="email" class="col12  obrigatorio" validar="Control_Layoult_Valida_EMAIL"  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="14" type="text" value="" MAXLENGTH="100" id="email2" name="email2" class="col12 " validar="Control_Layoult_Valida_EMAIL"  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                    <input tabindex="29" type="text" value="" MAXLENGTH="200" id="login" name="login" class="col12  obrigatorio"  /> 
                                                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                                            <input tabindex="30" type="password" value="" MAXLENGTH="200" id="senha" name="senha" class="col12 obrigatorio"  /> 
                                                </div>  
                                            </div>
                                            <div class="control-group">
                                                <label for="obs" class="control-label">Observação</label>
                                                <div class="controls">
                                                                <textarea style="height:200px;" class=" col12" id="obs" name="obs" maxlength="10000" tabindex="15"></textarea>
                                                                <!---->
                                                </div>
                                            </div>

                                            <div class="control-group">
                                                <label class="control-label" for="ct_captcha">Preencha por segurança*:</label>
                                                <div class="controls">                    
                                                <?php
                                            ...
                                            <div class="form-actions">
                                                <input type="submit" class="btn btn-success" value="Cadastrar" tabindex="34" />
                                            </div>
...
<?php /*LAYOULT DO ADMIN */  /*?>
   ...
   <!-- Load javascripts at bottom, this will reduce page load time --> 
    <script type="text/javascript">console.time('Sistema');</script>  
     ...
     <div class="push"></div><!-- .push --><div id="escondido"></div><div class="growlUI" style="display:none;"><h1>SierraTecnologia</h1> <h2>Ricardo Sierra <sierra.csi@gmail.com></h2></div><div id="popup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="popup" aria-hidden="true"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h3 id="popuptitulo">Popup</h3></div><div class="modal-body"></div><div class="modal-footer"></div></div><script type="text/javascript" src="<?php echo $endereco_admin; ?>/web/min/?f=lang/ptBR/Linguagem.js,sistema/modernizr/modernizr.js,sistema/jquery/jquery.min.js,sistema/jquery.browser.js,sistema/historico/jquery.history.js,sistema/nprogress/nprogress.js,sistema/toastr/toastr.min.js,js/jquery/jquery.blockUI.js,js/jquery/jquery.tabify.js,js/jquery/jquery.limit.js,assets/bootstrap-mask/jquery.maskedinput-1.3.min.js,js/jquery/jquery.fullcalendar.js,sistema/jquery-ui/jquery-ui.min.js,sistema/bootstrap/js/bootstrap.min.js,sistema/bootstrap/js/bootstrap-fileupload.js,assets/data-tables/jquery.dataTables.js,assets/data-tables/DT_bootstrap.js,assets/uniform/jquery.uniform.min.js,assets/chosen/chosen.jquery.min.js,assets/jquery-tags-input/jquery.tagsinput.min.js,assets/bootstrap-wysihtml5/wysihtml5-0.3.0.js,assets/bootstrap-wysihtml5/bootstrap-wysihtml5.js,sistema/bootstrap-duallistbox/jquery.bootstrap-duallistbox.js,assets/bootstrap-datepicker/js/bootstrap-datepicker.js,assets/bootstrap-timepicker/js/bootstrap-timepicker.js,assets/bootstrap-timepicker/jquery-ui-timepicker-addon.js,assets/bootstrap-daterangepicker/date.js,assets/bootstrap-daterangepicker/daterangepicker.js,assets/jquery-slimscroll/jquery.slimscroll.min.js,assets/bootstrap-colorpicker/js/bootstrap-colorpicker.js,assets/bootstrap-inputmask/bootstrap-inputmask.min.js,js/plugins/form-component.js,assets/metr-folio/js/jquery.metro-gal.plugins.min.js,assets/metr-folio/js/jquery.metro-gal.megafoliopro.js,sistema/sistema.js"></script><script type="text/javascript" language="javascript">$(document).ready(function() {if(window.location.hash!='') location.href='http://localhost/Framework/www/'+window.location.hash.replace(/#/g, '');ConfigArquivoPadrao = 'http://localhost/Framework/www/';Config_Form_Maiusculo = false;UserLogado = 2;Configuracoes_Template = new Array();Configuracoes_Template["datatable_sdom"]="<'row'<'col-6'l><'col-6'f>r>t<'row'<'col-6'i><'col-6'p>>";Configuracoes_Template["datatable_sPaginationType"]="bootstrap";Configuracoes_Template["datatable_bJQueryUI"]="";Configuracoes_Template["datatable_bAutoWidth"]="1";Sierra.Cache_Deletar('Dependencias_Css');setTimeout(function(){Sierra.Cache_Gravar('Dependencias_Css','sistema/jquery-ui/jquery-ui.min|sistema/bootstrap/css/bootstrap.min|sistema/bootstrap/css/bootstrap-responsive.min|sistema/bootstrap/css/bootstrap-fileupload|sistema/nprogress/nprogress|sistema/toastr/toastr.min|css/plugins/jquery.tiptip|css/plugins/jquery.blockui|css/jcalendar|css/plugins/jquery.fullcalendar|css/plugins/jquery.fullcalendar.print|assets/font-awesome/css/font-awesome|assets/metr-folio/css/metro-gallery|assets/uniform/css/uniform.default|assets/chosen/chosen.min|assets/jquery-tags-input/jquery.tagsinput|assets/bootstrap-datepicker/css/datepicker|assets/bootstrap-timepicker/compiled/timepicker|assets/bootstrap-colorpicker/css/colorpicker|assets/bootstrap-daterangepicker/daterangepicker|assets/bootstrap-wysihtml5/bootstrap-wysihtml5|sistema/bootstrap-duallistbox/bootstrap-duallistbox|css/sistema');},10);Sierra.Cache_Deletar('Dependencias_Js');setTimeout(function(){Sierra.Cache_Gravar('Dependencias_Js','lang/ptBR/Linguagem|sistema/modernizr/modernizr|sistema/jquery/jquery.min|sistema/jquery.browser|sistema/historico/jquery.history|sistema/nprogress/nprogress|sistema/toastr/toastr.min|js/jquery/jquery.blockUI|js/jquery/jquery.tabify|js/jquery/jquery.limit|assets/bootstrap-mask/jquery.maskedinput-1.3.min|js/jquery/jquery.fullcalendar|sistema/jquery-ui/jquery-ui.min|sistema/bootstrap/js/bootstrap.min|sistema/bootstrap/js/bootstrap-fileupload|assets/data-tables/jquery.dataTables|assets/data-tables/DT_bootstrap|assets/uniform/jquery.uniform.min|assets/chosen/chosen.jquery.min|assets/jquery-tags-input/jquery.tagsinput.min|assets/bootstrap-wysihtml5/wysihtml5-0.3.0|assets/bootstrap-wysihtml5/bootstrap-wysihtml5|sistema/bootstrap-duallistbox/jquery.bootstrap-duallistbox|assets/bootstrap-datepicker/js/bootstrap-datepicker|assets/bootstrap-timepicker/js/bootstrap-timepicker|assets/bootstrap-timepicker/jquery-ui-timepicker-addon|assets/bootstrap-daterangepicker/date|assets/bootstrap-daterangepicker/daterangepicker|assets/jquery-slimscroll/jquery.slimscroll.min|assets/bootstrap-colorpicker/js/bootstrap-colorpicker|assets/bootstrap-inputmask/bootstrap-inputmask.min|js/plugins/form-component|assets/metr-folio/js/jquery.metro-gal.plugins.min|assets/metr-folio/js/jquery.metro-gal.megafoliopro|sistema/sistema');},10);});</script>
