<div class="new-product-block">
				<ul class="product-grid">
					<li>
						<div class="pro-img"><img title="Freature Product" alt="Freature Product" src="images/curso1.jpg" /></div>
						<div class="pro-content"><p>Curso de Cardiologia<br>Período: 01/03 a 02/04
                        
                        </p></div>
						<div class="pro-price">R$0,00                      </div>
						<div class="pro-btn-block">
							<a class="add-cart left" href="#" title="Adicionar">Adicionar</a>
							<a class="add-cart right quickCart inline" href="#quick-view-container" title="Ver mais">Ver mais</a>					</div>
